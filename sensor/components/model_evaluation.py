...
import os, sys
from sensor.ml.mertic.classification_metric import get_classification_score
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)-> ModelEvaluationArtifact:
        try:
            ...
            #valid train and test file data frame
            ...
            improved_accuracy = trained_metric.f1_score-latest_metric
